...
const DistributorPayables = lazyWithOfflineFallback(() => import('./pages/DistributorPayables'), 'Distributor Payables')
    ...
    <>
      ...
      <Suspense fallback={!loading ? <LoadingState progress={50} /> : null}>
        <Routes>
          ...
          <Route path="/distributors/payables" element={
            <LoginGate>
              <Layout>
                <ProtectedRoute pageKey="distributors"><DistributorPayables /></ProtectedRoute>
              </Layout>
            </LoginGate>
          } />
