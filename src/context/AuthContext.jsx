...
export const ALL_PAGES = [
  ...
  { path: '/distributors/payables', name: 'Distributor Payables', key: 'distributors' },
...
export const AuthProvider = ({ children }) => {
  ...
  // Update user - defined before login so it can be used there
  ...
  const login = useCallback(async (username, password) => {
    ...
    if (user.passwordHash) {
      ...
      if (user.password === trimmedPassword) {
        ...
        // Update user directly without calling updateUser to avoid circular dependency
        ...
        if (isFirebaseConfigured() && online) {
          try {
            ...
            console.warn('Failed to update user password hash in Firebase:', error)
          }
        }
      }
    }
